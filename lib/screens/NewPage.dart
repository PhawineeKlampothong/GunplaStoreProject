...
class _NewPageState extends State<NewPage> {
  List<gunpla> pla = [
    ...
    gunpla("30MS OPTION PARTS SET 7 (EVIL COSTUME) COLOR A", 600),
    gunpla("30MS OPTION BODY PARTS ARM & LEG PARTS (BLACK)", 360),
    gunpla("30MS OPTION BODY PARTS ARM & LEG PARTS (WHITE)", 560),
    gunpla("30MS OPTION BODY PARTS ARM & LEG PARTS (PURPLE)", 760),
    gunpla("30MM 1/144 EXM-H15C ACERBY (TYPE-C)", 710),
    gunpla("30MS SIS-Tc20g TUKIRNA-DIEARTH(INNOCENTE FORM)", 1400),
    gunpla("AGATSUMA ZENITSU", 1850),
    gunpla("30MS OPTION HAIR STYLE PARTS Vol.9 ALL 4 TYPES", 826),
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 4,
            childAspectRatio: 12 / 16.5,
          ),
          itemBuilder: (context, index) {
            gunpla gun = pla[index];
            final String image = 'assets/images/NewArrivals/ar_${index + 1}.jpg';
              ...
              children: <Widget>[
                ...
                Text(
                  ...
                  style: Theme.of(context)
                      .textTheme
                      .headline6!
                      .copyWith(fontWeight: FontWeight.bold, color: Colors.yellow,fontSize: 30),
                ),
                Text(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: Theme.of(context)
                              .textTheme
                              .headline6!
                              .copyWith(fontWeight: FontWeight.bold, color: Colors.yellowAccent.shade700,fontSize: 30),
                        ),
                        Text(
                          'ราคา '+widget.price.toString() + ' บาท',
                          style: Theme.of(context)
                              .textTheme
                              .headline6!
                              .copyWith(fontWeight: FontWeight.bold, color: Colors.red,fontSize: 30),
                        ),
                        Row(
