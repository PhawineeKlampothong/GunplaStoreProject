...
class _rgState extends State<rg> {
  List<gunpla> pla = [
    gunpla("LED UNIT FOR PG GUNDAM EXIA", 5240),
    gunpla("PG UNICORN GUNDAM 02 BANSHEE NORN", 7480),
    gunpla("PG STRIKE FREEDOM GUNDAM", 8500),
    gunpla("PG 00 GUNDAM SEVEN SWORD/G", 8290),
    gunpla("PG GUNDAM EXIA", 6490),
    gunpla("PG GUNDAM ASTRAY RED FRAME", 6120),
    gunpla("PG STRIKE ROUGE + SKYGRASPER", 6460),
    gunpla("PG UNLEASHED RX-78-2 GUNDAM (40TH ANNIVERSARY VER)", 10450),
  ];
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final String image = 'assets/images/rgshop/rg_${index + 1}.jpg';
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () {
                Navigator.popAndPushNamed(context, '/rg');
              },
              child: Text("ตกลง"),
            ),
          ],
